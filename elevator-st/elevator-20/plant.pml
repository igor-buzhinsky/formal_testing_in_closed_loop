...
d_step {
    ...
    :: open[14] -> 
        if
        :: ((door_state[14] == d_closed) || (door_state[14] == d_closing)) -> 
    ...
    :: else -> 
        if
        :: ((door_state[14] == d_open) || (door_state[14] == d_opening)) -> 
    ...
    if
    :: (on_floor[14] && door_open[14]) -> 
        button[14] = false;
        call[14] = false;
    :: else -> 
        button[14] = (button[14] || user_floor_button[14]);
        call[14] = (call[14] || user_cabin_button[14]);
    fi
    on_floor[15] = (elevator_pos == 45);
    if
    :: open[15] -> 
        if
        :: ((door_state[15] == d_closed) || (door_state[15] == d_closing)) -> 
    ...
    :: else -> 
        if
        :: ((door_state[15] == d_open) || (door_state[15] == d_opening)) -> 
    ...
    if
    :: (on_floor[15] && door_open[15]) -> 
        button[15] = false;
        call[15] = false;
    :: else -> 
        button[15] = (button[15] || user_floor_button[15]);
        call[15] = (call[15] || user_cabin_button[15]);
    fi
    on_floor[16] = (elevator_pos == 48);
    if
    :: open[16] -> 
        if
        :: ((door_state[16] == d_closed) || (door_state[16] == d_closing)) -> 
    ...
    :: else -> 
        if
        :: ((door_state[16] == d_open) || (door_state[16] == d_opening)) -> 
    ...
    if
    :: (on_floor[16] && door_open[16]) -> 
        button[16] = false;
        call[16] = false;
    :: else -> 
        button[16] = (button[16] || user_floor_button[16]);
        call[16] = (call[16] || user_cabin_button[16]);
    fi
    on_floor[17] = (elevator_pos == 51);
    if
    :: open[17] -> 
        if
        :: ((door_state[17] == d_closed) || (door_state[17] == d_closing)) -> 
    ...
    :: else -> 
        if
        :: ((door_state[17] == d_open) || (door_state[17] == d_opening)) -> 
    ...
    if
    :: (on_floor[17] && door_open[17]) -> 
        button[17] = false;
        call[17] = false;
    :: else -> 
        button[17] = (button[17] || user_floor_button[17]);
        call[17] = (call[17] || user_cabin_button[17]);
    fi
    on_floor[18] = (elevator_pos == 54);
    if
    :: open[18] -> 
        if
        :: ((door_state[18] == d_closed) || (door_state[18] == d_closing)) -> 
            door_state[18] = d_opening;
        :: else -> 
            door_state[18] = d_open;
        fi
    :: else -> 
        if
        :: ((door_state[18] == d_open) || (door_state[18] == d_opening)) -> 
            door_state[18] = d_closing;
        :: else -> 
            door_state[18] = d_closed;
        fi
    fi
    door_closed[18] = (door_state[18] == d_closed);
    door_open[18] = (door_state[18] == d_open);
    if
    :: (on_floor[18] && door_open[18]) -> 
        button[18] = false;
        call[18] = false;
    :: else -> 
        button[18] = (button[18] || user_floor_button[18]);
        call[18] = (call[18] || user_cabin_button[18]);
    fi
    on_floor[19] = (elevator_pos == 57);
    if
    :: open[19] -> 
        if
        :: ((door_state[19] == d_closed) || (door_state[19] == d_closing)) -> 
            door_state[19] = d_opening;
        :: else -> 
            door_state[19] = d_open;
        fi
    :: else -> 
        if
        :: ((door_state[19] == d_open) || (door_state[19] == d_opening)) -> 
            door_state[19] = d_closing;
        :: else -> 
            door_state[19] = d_closed;
        fi
    fi
    door_closed[19] = (door_state[19] == d_closed);
    door_open[19] = (door_state[19] == d_open);
    if
    :: (on_floor[19] && door_open[19]) -> 
        button[19] = false;
        call[19] = false;
    :: else -> 
        button[19] = (button[19] || user_floor_button[19]);
        call[19] = (call[19] || user_cabin_button[19]);
    fi
}
