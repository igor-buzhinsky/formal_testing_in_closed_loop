...
d_step {
    ...
    if
    :: ((!(open[18]) && on_floor[18]) && (button[18] || call[18])) -> 
        door_timer = 4;
        timer_set = true;
    :: else -> ;
    fi
    if
    :: ((!(open[19]) && on_floor[19]) && (button[19] || call[19])) -> 
        door_timer = 4;
        timer_set = true;
    :: else -> ;
    fi
    ...
    on_some_floor = (on_some_floor || on_floor[18]);
    is_requested = ((is_requested || button[18]) || call[18]);
    open[18] = (open[18] && !(door_open[18]));
    on_some_floor = (on_some_floor || on_floor[19]);
    is_requested = ((is_requested || button[19]) || call[19]);
    open[19] = (open[19] && !(door_open[19]));
    need_stop = false;
    if
    :: !(on_some_floor) -> ;
    :: !(is_requested) -> 
    ...
    :: else -> 
        ...
        need_stop = ((need_stop || !(door_closed[18])) || (on_floor[18] && (button[18] || call[18])));
        open[18] = (open[18] || (on_floor[18] && (button[18] || call[18])));
        need_stop = ((need_stop || !(door_closed[19])) || (on_floor[19] && (button[19] || call[19])));
        open[19] = (open[19] || (on_floor[19] && (button[19] || call[19])));
        if
        :: need_stop -> 
            up = false;
            down = false;
        :: else -> 
            ...
            if
            :: (on_floor[18] && (button[0] || call[0])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            if
            :: (on_floor[19] && (button[0] || call[0])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            ...
            if
            :: (on_floor[18] && (button[1] || call[1])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            if
            :: (on_floor[19] && (button[1] || call[1])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            ...
            if
            :: (on_floor[18] && (button[2] || call[2])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            if
            :: (on_floor[19] && (button[2] || call[2])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            ...
            if
            :: (on_floor[18] && (button[3] || call[3])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            if
            :: (on_floor[19] && (button[3] || call[3])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            ...
            if
            :: (on_floor[18] && (button[4] || call[4])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            if
            :: (on_floor[19] && (button[4] || call[4])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            ...
            if
            :: (on_floor[18] && (button[5] || call[5])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            if
            :: (on_floor[19] && (button[5] || call[5])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            ...
            if
            :: (on_floor[18] && (button[6] || call[6])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            if
            :: (on_floor[19] && (button[6] || call[6])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            ...
            if
            :: (on_floor[18] && (button[7] || call[7])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            if
            :: (on_floor[19] && (button[7] || call[7])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            ...
            if
            :: (on_floor[18] && (button[8] || call[8])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            if
            :: (on_floor[19] && (button[8] || call[8])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            ...
            if
            :: (on_floor[18] && (button[9] || call[9])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            if
            :: (on_floor[19] && (button[9] || call[9])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            ...
            if
            :: (on_floor[18] && (button[10] || call[10])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            if
            :: (on_floor[19] && (button[10] || call[10])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            ...
            if
            :: (on_floor[18] && (button[11] || call[11])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            if
            :: (on_floor[19] && (button[11] || call[11])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            ...
            if
            :: (on_floor[18] && (button[12] || call[12])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            if
            :: (on_floor[19] && (button[12] || call[12])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            ...
            if
            :: (on_floor[18] && (button[13] || call[13])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            if
            :: (on_floor[19] && (button[13] || call[13])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            ...
            if
            :: (on_floor[18] && (button[14] || call[14])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            if
            :: (on_floor[19] && (button[14] || call[14])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            ...
            if
            :: (on_floor[18] && (button[15] || call[15])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            if
            :: (on_floor[19] && (button[15] || call[15])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            ...
            if
            :: (on_floor[18] && (button[16] || call[16])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            if
            :: (on_floor[19] && (button[16] || call[16])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            ...
            if
            :: (on_floor[18] && (button[17] || call[17])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            if
            :: (on_floor[19] && (button[17] || call[17])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            if
            :: (on_floor[0] && (button[18] || call[18])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[1] && (button[18] || call[18])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[2] && (button[18] || call[18])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[3] && (button[18] || call[18])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[4] && (button[18] || call[18])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[5] && (button[18] || call[18])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[6] && (button[18] || call[18])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[7] && (button[18] || call[18])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[8] && (button[18] || call[18])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[9] && (button[18] || call[18])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[10] && (button[18] || call[18])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[11] && (button[18] || call[18])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[12] && (button[18] || call[18])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[13] && (button[18] || call[18])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[14] && (button[18] || call[18])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[15] && (button[18] || call[18])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[16] && (button[18] || call[18])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[17] && (button[18] || call[18])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[19] && (button[18] || call[18])) -> 
                up = false;
                down = true;
            :: else -> ;
            fi
            if
            :: (on_floor[0] && (button[19] || call[19])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[1] && (button[19] || call[19])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[2] && (button[19] || call[19])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[3] && (button[19] || call[19])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[4] && (button[19] || call[19])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[5] && (button[19] || call[19])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[6] && (button[19] || call[19])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[7] && (button[19] || call[19])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[8] && (button[19] || call[19])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[9] && (button[19] || call[19])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[10] && (button[19] || call[19])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[11] && (button[19] || call[19])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[12] && (button[19] || call[19])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[13] && (button[19] || call[19])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[14] && (button[19] || call[19])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[15] && (button[19] || call[19])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[16] && (button[19] || call[19])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[17] && (button[19] || call[19])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
            if
            :: (on_floor[18] && (button[19] || call[19])) -> 
                up = true;
                down = false;
            :: else -> ;
            fi
    ...
    open[18] = (open[18] || (door_open[18] && (door_timer > 0)));
    open[19] = (open[19] || (door_open[19] && (door_timer > 0)));
}
