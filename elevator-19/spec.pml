...
ltl door16_delay_1step { X( [](!door_open[16] -> X(door_open[16] -> X(door_open[16] && X(!door_open[16])))) ) } // false
ltl door17_delay_1step { X( [](!door_open[17] -> X(door_open[17] -> X(door_open[17] && X(!door_open[17])))) ) } // false
ltl door18_delay_1step { X( [](!door_open[18] -> X(door_open[18] -> X(door_open[18] && X(!door_open[18])))) ) } // false
...
ltl door16_reopen_1step { X( [](door_open[16] -> X(!door_open[16] && (user_floor_button[16] || user_cabin_button[16]) -> X(door_open[16])))) } // false
ltl door17_reopen_1step { X( [](door_open[17] -> X(!door_open[17] && (user_floor_button[17] || user_cabin_button[17]) -> X(door_open[17])))) } // false
ltl door18_reopen_1step { X( [](door_open[18] -> X(!door_open[18] && (user_floor_button[18] || user_cabin_button[18]) -> X(door_open[18])))) } // false
...
ltl door16_delay_2steps { X( [](!door_open[16] -> X(door_open[16] -> X(door_open[16] && X(door_open[16] && X(!door_open[16]))))) ) }
ltl door17_delay_2steps { X( [](!door_open[17] -> X(door_open[17] -> X(door_open[17] && X(door_open[17] && X(!door_open[17]))))) ) }
ltl door18_delay_2steps { X( [](!door_open[18] -> X(door_open[18] -> X(door_open[18] && X(door_open[18] && X(!door_open[18]))))) ) }
...
ltl door16_reopen_2steps { X( [](door_open[16] -> X(!door_open[16] && (user_floor_button[16] || user_cabin_button[16]) -> X(X(door_open[16]))))) }
ltl door17_reopen_2steps { X( [](door_open[17] -> X(!door_open[17] && (user_floor_button[17] || user_cabin_button[17]) -> X(X(door_open[17]))))) }
ltl door18_reopen_2steps { X( [](door_open[18] -> X(!door_open[18] && (user_floor_button[18] || user_cabin_button[18]) -> X(X(door_open[18]))))) }
...
ltl doors_closed_when_between_floors { X( [](!on_floor[0] && !on_floor[1] && !on_floor[2] && !on_floor[3] && !on_floor[4] && !on_floor[5] && !on_floor[6] && !on_floor[7] && !on_floor[8] && !on_floor[9] && !on_floor[10] && !on_floor[11] && !on_floor[12] && !on_floor[13] && !on_floor[14] && !on_floor[15] && !on_floor[16] && !on_floor[17] && !on_floor[18] -> door_closed[0] && door_closed[1] && door_closed[2] && door_closed[3] && door_closed[4] && door_closed[5] && door_closed[6] && door_closed[7] && door_closed[8] && door_closed[9] && door_closed[10] && door_closed[11] && door_closed[12] && door_closed[13] && door_closed[14] && door_closed[15] && door_closed[16] && door_closed[17] && door_closed[18]) ) }
...
ltl floor_reached_multiple_calls_16 { X( []((user_floor_button[16] || user_cabin_button[16]) -> <>on_floor[16]) ) } // false
ltl floor_reached_multiple_calls_17 { X( []((user_floor_button[17] || user_cabin_button[17]) -> <>on_floor[17]) ) } // false
ltl floor_reached_multiple_calls_18 { X( []((user_floor_button[18] || user_cabin_button[18]) -> <>on_floor[18]) ) } // false
