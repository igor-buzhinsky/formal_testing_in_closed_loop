...
ltl door5_delay { X( [](!door_open[5] -> X(!user_floor_button[5] && !user_cabin_button[5] && door_open[5] -> X(!user_floor_button[5] && !user_cabin_button[5] -> door_open[5] && X(!user_floor_button[5] && !user_cabin_button[5] -> door_open[5] && X(!user_floor_button[5] && !user_cabin_button[5] -> !door_open[5]))))) ) }
ltl door6_delay { X( [](!door_open[6] -> X(!user_floor_button[6] && !user_cabin_button[6] && door_open[6] -> X(!user_floor_button[6] && !user_cabin_button[6] -> door_open[6] && X(!user_floor_button[6] && !user_cabin_button[6] -> door_open[6] && X(!user_floor_button[6] && !user_cabin_button[6] -> !door_open[6]))))) ) }
ltl door7_delay { X( [](!door_open[7] -> X(!user_floor_button[7] && !user_cabin_button[7] && door_open[7] -> X(!user_floor_button[7] && !user_cabin_button[7] -> door_open[7] && X(!user_floor_button[7] && !user_cabin_button[7] -> door_open[7] && X(!user_floor_button[7] && !user_cabin_button[7] -> !door_open[7]))))) ) }
ltl door8_delay { X( [](!door_open[8] -> X(!user_floor_button[8] && !user_cabin_button[8] && door_open[8] -> X(!user_floor_button[8] && !user_cabin_button[8] -> door_open[8] && X(!user_floor_button[8] && !user_cabin_button[8] -> door_open[8] && X(!user_floor_button[8] && !user_cabin_button[8] -> !door_open[8]))))) ) }
ltl door9_delay { X( [](!door_open[9] -> X(!user_floor_button[9] && !user_cabin_button[9] && door_open[9] -> X(!user_floor_button[9] && !user_cabin_button[9] -> door_open[9] && X(!user_floor_button[9] && !user_cabin_button[9] -> door_open[9] && X(!user_floor_button[9] && !user_cabin_button[9] -> !door_open[9]))))) ) }
ltl door10_delay { X( [](!door_open[10] -> X(!user_floor_button[10] && !user_cabin_button[10] && door_open[10] -> X(!user_floor_button[10] && !user_cabin_button[10] -> door_open[10] && X(!user_floor_button[10] && !user_cabin_button[10] -> door_open[10] && X(!user_floor_button[10] && !user_cabin_button[10] -> !door_open[10]))))) ) }
ltl door11_delay { X( [](!door_open[11] -> X(!user_floor_button[11] && !user_cabin_button[11] && door_open[11] -> X(!user_floor_button[11] && !user_cabin_button[11] -> door_open[11] && X(!user_floor_button[11] && !user_cabin_button[11] -> door_open[11] && X(!user_floor_button[11] && !user_cabin_button[11] -> !door_open[11]))))) ) }
ltl door12_delay { X( [](!door_open[12] -> X(!user_floor_button[12] && !user_cabin_button[12] && door_open[12] -> X(!user_floor_button[12] && !user_cabin_button[12] -> door_open[12] && X(!user_floor_button[12] && !user_cabin_button[12] -> door_open[12] && X(!user_floor_button[12] && !user_cabin_button[12] -> !door_open[12]))))) ) }
ltl door13_delay { X( [](!door_open[13] -> X(!user_floor_button[13] && !user_cabin_button[13] && door_open[13] -> X(!user_floor_button[13] && !user_cabin_button[13] -> door_open[13] && X(!user_floor_button[13] && !user_cabin_button[13] -> door_open[13] && X(!user_floor_button[13] && !user_cabin_button[13] -> !door_open[13]))))) ) }
ltl door14_delay { X( [](!door_open[14] -> X(!user_floor_button[14] && !user_cabin_button[14] && door_open[14] -> X(!user_floor_button[14] && !user_cabin_button[14] -> door_open[14] && X(!user_floor_button[14] && !user_cabin_button[14] -> door_open[14] && X(!user_floor_button[14] && !user_cabin_button[14] -> !door_open[14]))))) ) }
ltl door15_delay { X( [](!door_open[15] -> X(!user_floor_button[15] && !user_cabin_button[15] && door_open[15] -> X(!user_floor_button[15] && !user_cabin_button[15] -> door_open[15] && X(!user_floor_button[15] && !user_cabin_button[15] -> door_open[15] && X(!user_floor_button[15] && !user_cabin_button[15] -> !door_open[15]))))) ) }
ltl door16_delay { X( [](!door_open[16] -> X(!user_floor_button[16] && !user_cabin_button[16] && door_open[16] -> X(!user_floor_button[16] && !user_cabin_button[16] -> door_open[16] && X(!user_floor_button[16] && !user_cabin_button[16] -> door_open[16] && X(!user_floor_button[16] && !user_cabin_button[16] -> !door_open[16]))))) ) }
ltl door17_delay { X( [](!door_open[17] -> X(!user_floor_button[17] && !user_cabin_button[17] && door_open[17] -> X(!user_floor_button[17] && !user_cabin_button[17] -> door_open[17] && X(!user_floor_button[17] && !user_cabin_button[17] -> door_open[17] && X(!user_floor_button[17] && !user_cabin_button[17] -> !door_open[17]))))) ) }
ltl door18_delay { X( [](!door_open[18] -> X(!user_floor_button[18] && !user_cabin_button[18] && door_open[18] -> X(!user_floor_button[18] && !user_cabin_button[18] -> door_open[18] && X(!user_floor_button[18] && !user_cabin_button[18] -> door_open[18] && X(!user_floor_button[18] && !user_cabin_button[18] -> !door_open[18]))))) ) }
...
ltl phi04_1 { X( []<>!down ) }
ltl phi04_2 { X( []<>!up ) }
ltl phi15 { X( [](!on_floor[0] && !on_floor[1] && !on_floor[2] && !on_floor[3] && !on_floor[4] && !on_floor[5] && !on_floor[6] && !on_floor[7] && !on_floor[8] && !on_floor[9] && !on_floor[10] && !on_floor[11] && !on_floor[12] && !on_floor[13] && !on_floor[14] && !on_floor[15] && !on_floor[16] && !on_floor[17] && !on_floor[18] -> door_closed[0] && door_closed[1] && door_closed[2] && door_closed[3] && door_closed[4] && door_closed[5] && door_closed[6] && door_closed[7] && door_closed[8] && door_closed[9] && door_closed[10] && door_closed[11] && door_closed[12] && door_closed[13] && door_closed[14] && door_closed[15] && door_closed[16] && door_closed[17] && door_closed[18]) ) }
...
ltl phi11_17 { X( []((user_floor_button[17] || user_cabin_button[17]) -> <>on_floor[17]) ) } // false
ltl phi11_18 { X( []((user_floor_button[18] || user_cabin_button[18]) -> <>on_floor[18]) ) } // false
