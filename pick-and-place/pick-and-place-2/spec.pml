...
ltl additional3_MUST_BE_TRUE { X( (!(vcyl_extend || vcyl_extended || suction_on) U (wp[0] || wp[1] || wp[2])) || ([] !(vcyl_extend || vcyl_extended || suction_on)) ) }
...
ltl additional3_MUST_BE_FALSE { X( (!(vcyl_extend || vcyl_extended || suction_on) U (wp[0] && wp[1] && wp[2])) || ([] !(vcyl_extend || vcyl_extended || suction_on)) ) }
