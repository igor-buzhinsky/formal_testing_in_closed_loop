...
ltl doors_closed_when_between_floors_MUST_BE_TRUE { X( [](!on_floor[0] && !on_floor[1] && !on_floor[2] -> door_closed[0] && door_closed[1] && door_closed[2]) ) }
ltl doors_open_when_between_floors_MUST_BE_FALSE { X( [](!on_floor[0] && !on_floor[1] && !on_floor[2] -> door_open[0] && door_open[1] && door_open[2]) ) }
