...
ltl doors_closed_when_between_floors_MUST_BE_TRUE { X( [](!on_floor[0] && !on_floor[1] && !on_floor[2] && !on_floor[3] && !on_floor[4] && !on_floor[5] && !on_floor[6] && !on_floor[7] && !on_floor[8] && !on_floor[9] && !on_floor[10] && !on_floor[11] && !on_floor[12] && !on_floor[13] && !on_floor[14] && !on_floor[15] && !on_floor[16] -> door_closed[0] && door_closed[1] && door_closed[2] && door_closed[3] && door_closed[4] && door_closed[5] && door_closed[6] && door_closed[7] && door_closed[8] && door_closed[9] && door_closed[10] && door_closed[11] && door_closed[12] && door_closed[13] && door_closed[14] && door_closed[15] && door_closed[16]) ) }
ltl doors_open_when_between_floors_MUST_BE_FALSE { X( [](!on_floor[0] && !on_floor[1] && !on_floor[2] && !on_floor[3] && !on_floor[4] && !on_floor[5] && !on_floor[6] && !on_floor[7] && !on_floor[8] && !on_floor[9] && !on_floor[10] && !on_floor[11] && !on_floor[12] && !on_floor[13] && !on_floor[14] && !on_floor[15] && !on_floor[16] -> door_open[0] && door_open[1] && door_open[2] && door_open[3] && door_open[4] && door_open[5] && door_open[6] && door_open[7] && door_open[8] && door_open[9] && door_open[10] && door_open[11] && door_open[12] && door_open[13] && door_open[14] && door_open[15] && door_open[16]) ) }
